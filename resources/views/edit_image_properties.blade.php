                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        <li class="breadcrumb-item">
                                ...
                                <i class="">Edit Properties Image</i>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                                            ...
                                            <b>{{ $editdata['property_type_name'] }}</b>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-4 offset-1 card">
                                                            ...
                                                            <div class="card-block filesuploaded">
                                                                ...
                                                                {
                                                                    echo "<h5 class='alert alert-red'>There is no image for this Property.</h5>";
                                                        ...
                                                        <div class="col-sm-4 offset-1 card">
                                                            ...
                                                            <div class="card-block">
                                                                <form id="uploadform" action="{{url('assets/storeimage/properties/'.$editdata['id']) }}" method="post" id="addprocat"
                            ...
                            <div class="form-group row mb-5">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                        ...
                                        <a href="{{ url('properties/'.$editdata['id'].'/edit') }}"
