            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="dropzone" action="{{route('roomtype.update',['roomtype'=>$rooms['id']]) }}" method="post" id="editstatus"
                        ...
                        @endif
                                                    ...
                                                    <div class="form-group row ">
                                                    <div class="col-sm-4">
                                                        <label class="col-form-label text-md-right">No Of Room</label>
                                                      
                                                            <input value="{{ old('no_of_rooms',$rooms['no_of_rooms']) }}" name="no_of_rooms" class="summernote-simple form-control" required>
                                                        </div>

                                                        <div class="col-sm-4">
                                                        <label class="col-form-label text-md-right">Room Location</label>
                                                      
                                                            <input value="{{ old('room_location',$rooms['room_location']) }}" name="room_location" class="summernote-simple form-control" required>
                                                        </div>

                                                    <div class="col-sm-4">
                                                        <label class="col-form-label text-md-right">Max Adults</label>
                                                      
                                                            <textarea name="max_adults" class="summernote-simple form-control" required>{{ old('max_adults',$rooms['max_adults']) }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <label class="col-form-label text-md-right">Max Children</label>
                                                            ...
                                                            <input value="{{ old('max_children',$rooms['max_children']) }}" name="max_children" class="summernote-simple form-control" required>
                                                        </div>

                                                        <div class="col-sm-4 ">
                                                        <label class="col-form-label text-md-right">Max Occupancy</label>
                                                      
                                                            <input value="{{ old('max_occupancy',$rooms['max_occupancy']) }}" name="max_occupancy" class="summernote-simple form-control" required>
                                                        </div>
