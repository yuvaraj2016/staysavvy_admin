...
<div class="col-sm-4 ">
                            ...
                            <input type="text"  value="   {{ $rooms['no_of_rooms'] }}" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4 ">
                            <label class="col-form-label text-md-right ">Room Location</label>
                            <input type="text"  value="   {{ $rooms['room_location'] }}" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4 ">
                            <label class="col-form-label text-md-right ">Max Adults </label>
                            <input type="text"  value="    {{ $rooms['max_adults'] }}" class="form-control" readonly>
...
<div class="col-sm-4 ">
                            ...
                            <input type="text"  value="   {{ $rooms['max_children'] }}" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4 ">
                            <label class="col-form-label text-md-right ">Max Occupancy</label>
                            <input type="text"  value="   {{ $rooms['max_occupancy'] }}" class="form-control" readonly>
                            </div>
                            <div class="col-sm-4 ">
